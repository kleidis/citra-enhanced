...
bool Room::RoomImpl::HasModPermission(const ENetPeer* client) const {
    ...
    if (room_information.enable_mandarin_mods &&
...
bool Room::Create(const std::string& name, const std::string& description,
                  ...
                  std::unique_ptr<VerifyUser::Backend> verify_backend,
                  const Room::BanList& ban_list, bool enable_mandarin_mods) {
    ENetAddress address;
    ...
    room_impl->room_information.enable_mandarin_mods = enable_mandarin_mods;
