...
void Thread::Stop() {
    ...
    u32 tls_page = (tls_address - Memory::TLS_AREA_VADDR) / Memory::MANDARIN_PAGE_SIZE;
    u32 tls_slot =
        ((tls_address - Memory::TLS_AREA_VADDR) % Memory::MANDARIN_PAGE_SIZE) / Memory::TLS_ENTRY_SIZE;
