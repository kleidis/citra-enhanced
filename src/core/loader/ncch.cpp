...
ResultStatus AppLoader_NCCH::LoadExec(std::shared_ptr<Kernel::Process>& process) {
    ...
    if (ResultStatus::Success == ReadCode(code) &&
        ...
        codeset->CodeSegment().size =
            overlay_ncch->exheader_header.codeset_info.text.num_max_pages * Memory::MANDARINE_PAGE_SIZE;
        ...
        codeset->RODataSegment().size =
            overlay_ncch->exheader_header.codeset_info.ro.num_max_pages * Memory::MANDARINE_PAGE_SIZE;
