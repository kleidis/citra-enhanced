...
# from a controller device to the client program. Mandarin has a client that can connect and read
...
[System]
# The system model that Mandarin will try to emulate
...
# The system region that Mandarin will use during emulation
# -1: Auto-select (default), 0: Japan, 1: USA, 2: Europe, 3: Australia, 4: China, 5: Korea, 6: Taiwan
region_value =

# The system language that Mandarin will use during emulation
