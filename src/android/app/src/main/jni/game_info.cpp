...
JNIEXPORT jlong JNICALL Java_io_github_mandarine3ds_mandarine_model_GameInfo_initialize(JNIEnv* env, jclass,
                                                                            jstring j_path) {
...
JNIEXPORT void JNICALL Java_io_github_mandarine3ds_mandarine_model_GameInfo_finalize(JNIEnv* env, jobject obj) {
