...
JNIEXPORT void JNICALL Java_io_github_mandarine3ds_mandarine_features_cheats_model_Cheat_finalize(JNIEnv* env,
                                                                                      jobject obj) {
    delete CheatFromJava(env, obj);
}

JNIEXPORT jstring JNICALL
Java_io_github_mandarine3ds_mandarine_features_cheats_model_Cheat_getName(JNIEnv* env, jobject obj) {
    return ToJString(env, (*CheatFromJava(env, obj))->GetName());
}

JNIEXPORT jstring JNICALL
Java_io_github_mandarine3ds_mandarine_features_cheats_model_Cheat_getNotes(JNIEnv* env, jobject obj) {
    return ToJString(env, (*CheatFromJava(env, obj))->GetComments());
}

JNIEXPORT jstring JNICALL
Java_io_github_mandarine3ds_mandarine_features_cheats_model_Cheat_getCode(JNIEnv* env, jobject obj) {
    return ToJString(env, (*CheatFromJava(env, obj))->GetCode());
}

JNIEXPORT jboolean JNICALL
Java_io_github_mandarine3ds_mandarine_features_cheats_model_Cheat_getEnabled(JNIEnv* env, jobject obj) {
    return static_cast<jboolean>((*CheatFromJava(env, obj))->IsEnabled());
}

JNIEXPORT void JNICALL Java_io_github_mandarine3ds_mandarine_features_cheats_model_Cheat_setEnabledImpl(
    JNIEnv* env, jobject obj, jboolean j_enabled) {
    (*CheatFromJava(env, obj))->SetEnabled(static_cast<bool>(j_enabled));
}

JNIEXPORT jint JNICALL Java_io_github_mandarine3ds_mandarine_features_cheats_model_Cheat_isValidGatewayCode(
...
JNIEXPORT jobject JNICALL Java_io_github_mandarine3ds_mandarine_features_cheats_model_Cheat_createGatewayCode(
