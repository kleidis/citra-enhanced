...
void InitJNI(JNIEnv* env) {
    s_software_keyboard_class = reinterpret_cast<jclass>(
        env->NewGlobalRef(env->FindClass("io/github/mandarine3ds/mandarine/applets/SoftwareKeyboard")));
    s_keyboard_config_class = reinterpret_cast<jclass>(env->NewGlobalRef(
        env->FindClass("io/github/mandarine3ds/mandarine/applets/SoftwareKeyboard$KeyboardConfig")));
    s_keyboard_data_class = reinterpret_cast<jclass>(env->NewGlobalRef(
        env->FindClass("io/github/mandarine3ds/mandarine/applets/SoftwareKeyboard$KeyboardData")));
    s_validation_error_class = reinterpret_cast<jclass>(env->NewGlobalRef(
        env->FindClass("io/github/mandarine3ds/mandarine/applets/SoftwareKeyboard$ValidationError")));

    s_swkbd_execute = env->GetStaticMethodID(
        s_software_keyboard_class, "Execute",
        "(Lio/github/mandarine3ds/mandarine/applets/SoftwareKeyboard$KeyboardConfig;)Lio/github/mandarine3ds/mandarine/"
...
jobject Java_io_github_mandarine3ds_mandarine_applets_SoftwareKeyboard_ValidateFilters(JNIEnv* env,
                                                                           jclass clazz,
                                                                           jstring text) {
...
jobject Java_io_github_mandarine3ds_mandarine_applets_SoftwareKeyboard_ValidateInput(JNIEnv* env, jclass clazz,
                                                                         jstring text) {
