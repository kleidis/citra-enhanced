...
class InputBindingSetting(
    ...
    private val context: Context get() = MandarineApplication.appContext
    ...
    /**
     * Returns the Mandarine button code for the settings key.
     */
    ...
    companion object {
        ...
        /**
         * Returns the settings key for the specified Mandarine button code.
         */
